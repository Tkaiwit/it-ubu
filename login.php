...
<body>
	<div id="container-login">
		...
		<div id="grid-two">
			...
			<div id="link-S-T">
				<a class="active" href="login.php">Login For students</a> <span>Or</span>
				<a href="login-teacher.php" id="teachers">Login For teachers</a>
			</div>
			<div id="link-l-r">
			...
			<form action="connectDB/login/checklogin.php" id="form-login" method="POST">
			<div id="input-user">
